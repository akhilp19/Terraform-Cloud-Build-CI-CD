...
locals {
  ...
  steps = [
    ...
    },
    {
        ...
        "--image", local.image, "--region", var.region, "--platform", "managed","-q"]
    }
  ]
}
...
#       name = "gcr.io/cloud-builders/go"
#       args = ["test"]
#       env  = ["PROJECT_ROOT=$(var.nsmespace)"]
#     }
...
#     step {
#       name = "gcr.io/cloud-builders/gcloud"
#       args = ["run", "deploy", google_cloud_run_service.name, "--image", local.image, "--region", var.region, "--platform", "managed", "-q"]
#     }
#   }
# }
